...
From MetaRocq.Common Require Transform.
Import Transform.

Program Definition inline_transformation (efl : EEnvFlags) (wfl : WcbvFlags) (inlining : inlining) (hApp : has_tApp) (hBox : has_tBox || ~~ with_prop_case) :
