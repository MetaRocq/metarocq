...
struct
 ...
 let quote_abstract_univ_context uctx =
  ...
  | GQSort (_, u) | Sorts.VQSort (_, u) -> constr_mkApp (sType, [| Lazy.force tuniverse; quote_universe u |]) (* FIXME *)
  ...
  let quote_sort_quality_or_set = function
    ...
    | UnivGen.QualityOrSet.(Qual (QVar _ | QGlobal _)) -> Lazy.force sfType (* FIXME *)
